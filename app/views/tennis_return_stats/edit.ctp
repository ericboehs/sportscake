...
<?php echo $form->create('TennisReturnStat');?>
	<fieldset>
 		<legend><?php __('Edit TennisReturnStat');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('TennisReturnStat.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('TennisReturnStat.id'))); ?></li>
