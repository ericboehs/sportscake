...
<?php echo $form->create('TeamPhase');?>
	<fieldset>
 		<legend><?php __('Edit TeamPhase');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('TeamPhase.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('TeamPhase.id'))); ?></li>
