...
<?php echo $form->create('SoccerActionSubstitution');?>
	<fieldset>
 		<legend><?php __('Edit SoccerActionSubstitution');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('SoccerActionSubstitution.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('SoccerActionSubstitution.id'))); ?></li>
