...
<?php echo $form->create('PersonPhase');?>
	<fieldset>
 		<legend><?php __('Edit PersonPhase');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('PersonPhase.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('PersonPhase.id'))); ?></li>
