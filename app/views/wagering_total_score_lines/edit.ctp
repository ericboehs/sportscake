<div class="wageringTotalScoreLines form">
<?php echo $form->create('WageringTotalScoreLine');?>
	<fieldset>
 		<legend><?php __('Edit WageringTotalScoreLine');?></legend>
	<?php
		echo $form->input('id');
		...
		echo $form->input('line_over');
		echo $form->input('line_under');
		echo $form->input('total');
		echo $form->input('total_opening');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('WageringTotalScoreLine.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('WageringTotalScoreLine.id'))); ?></li>
