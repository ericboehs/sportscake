...
<?php echo $form->create('BaseballActionSubstitution');?>
	<fieldset>
 		<legend><?php __('Edit BaseballActionSubstitution');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('BaseballActionSubstitution.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('BaseballActionSubstitution.id'))); ?></li>
