...
<?php echo $form->create('ParticipantsEvent');?>
	<fieldset>
 		<legend><?php __('Edit ParticipantsEvent');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('ParticipantsEvent.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('ParticipantsEvent.id'))); ?></li>
