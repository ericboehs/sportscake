...
<?php echo $form->create('SoccerEventState');?>
	<fieldset>
 		<legend><?php __('Edit SoccerEventState');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('SoccerEventState.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('SoccerEventState.id'))); ?></li>
