...
<?php echo $form->create('WageringMoneyline');?>
	<fieldset>
 		<legend><?php __('Edit WageringMoneyline');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('WageringMoneyline.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('WageringMoneyline.id'))); ?></li>
