...
<?php echo $form->create('WageringOddsLine');?>
	<fieldset>
 		<legend><?php __('Edit WageringOddsLine');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('WageringOddsLine.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('WageringOddsLine.id'))); ?></li>
