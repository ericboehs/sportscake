...
<?php echo $form->create('BaseballDefensivePlayer');?>
	<fieldset>
 		<legend><?php __('Edit BaseballDefensivePlayer');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('BaseballDefensivePlayer.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('BaseballDefensivePlayer.id'))); ?></li>
