...
<?php echo $form->create('BaseballActionPitch');?>
	<fieldset>
 		<legend><?php __('Edit BaseballActionPitch');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('BaseballActionPitch.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('BaseballActionPitch.id'))); ?></li>
