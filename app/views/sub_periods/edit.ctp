...
<?php echo $form->create('SubPeriod');?>
	<fieldset>
 		<legend><?php __('Edit SubPeriod');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('SubPeriod.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('SubPeriod.id'))); ?></li>
