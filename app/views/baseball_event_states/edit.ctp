...
<?php echo $form->create('BaseballEventState');?>
	<fieldset>
 		<legend><?php __('Edit BaseballEventState');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('BaseballEventState.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('BaseballEventState.id'))); ?></li>
