...
<?php echo $form->create('SoccerActionPlay');?>
	<fieldset>
 		<legend><?php __('Edit SoccerActionPlay');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('SoccerActionPlay.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('SoccerActionPlay.id'))); ?></li>
