...
<?php echo $form->create('TennisSetStat');?>
	<fieldset>
 		<legend><?php __('Edit TennisSetStat');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('TennisSetStat.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('TennisSetStat.id'))); ?></li>
