...
<?php echo $form->create('AmericanFootballActionPlay');?>
	<fieldset>
 		<legend><?php __('Edit AmericanFootballActionPlay');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('AmericanFootballActionPlay.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('AmericanFootballActionPlay.id'))); ?></li>
