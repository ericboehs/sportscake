...
<?php echo $form->create('BaseballOffensiveStat');?>
	<fieldset>
 		<legend><?php __('Edit BaseballOffensiveStat');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('BaseballOffensiveStat.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('BaseballOffensiveStat.id'))); ?></li>
