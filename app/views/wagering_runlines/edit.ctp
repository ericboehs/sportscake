<div class="wageringRunlines form">
<?php echo $form->create('WageringRunline');?>
	<fieldset>
 		<legend><?php __('Edit WageringRunline');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('WageringRunline.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('WageringRunline.id'))); ?></li>
