<?php
class LiveFeedDeliveryShell extends Shell {

	var $name = 'LiveFeedDelivery';
	...
	function startLiveFeedsProcess(){
		...
		exec("nohup '".$loc['cakeshell']."' live_feed_delivery -cli '".$loc['phpbin']."' -console '".$loc['cakeconsole']."' > /dev/null 2>&1 & echo $!",$op);
		$pid = (int)$op[0];
